...
\subsubsection{Extra Data, Data Structures and Algorithms Required}
\begin{itemize}
    \item $ V \times V $ matrix (another one if paths are needed)
    \item 
\end{itemize}
